...
public class NombresBean {
	...
	/**Servicios*/
	public static final String SERVICIO_LIBRO = "servicioLibro";
    public static final String SERVICIO_PERMISO_PERFIL = "servicioPermisoPerfil";
    public static final String SERVICIO_PERFIL = "servicioPerfil";
    public static final String SERVICIO_PRESTAMO = "servicioPrestamo";
    ...
    public static final String GESTION_PRESTAMOS_BEAN = "gestionPrestamosBean"; 
    ...
    /**Binding*/
    public static final String GESTION_LIBROS_BINDING = "gestionLibrosBinding"; 
    public static final String GESTION_PRESTAMOS_BINDING = "gestionPrestamosBinding"; 
    public static final String GESTION_USUARIOS_BINDING = "gestionUsuariosBinding"; 
    
    /**DAOs */
    public static final String LIBRO_DAO = "libroDAO"; 
    public static final String PERMISO_PERFIL_DAO = "permisoPerfilDAO"; 
    public static final String PERFIL_DAO = "perfilDAO"; 
    public static final String PRESTAMO_DAO = "prestamoDAO"; 
    public static final String USUARIO_DAO = "usuarioDAO"; 
    
    /**Utilidades**/
    public static final String SESION_HIBERNATE = "database";
