...
public class ConstantesReglasNavegacion {
	...
	public static final String EDITAR_CONFIGURACION_NOTIFICACIONES = "editarConfiguracionNotificaciones";
	...
	public static final String GESTION_COFIGURACION_NOTIFICACIONES_USUARIO = "gestionConfiguracionNotificacionesUsuarios";
    ...
    public static final String MENU_PRINCIPAL = "menuPrincial";
    public static final String MODIFICAR_PASSWORD = "modificarPassword";
}
