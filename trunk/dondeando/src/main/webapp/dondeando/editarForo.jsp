		...
		<trh:body initialFocusId="nombre">
			...
			<tr:form defaultCommand="btnAceptar" id="formCrearUsuario"
				...
				<tr:panelPage>
					...
					<tr:panelHeader text="#{editarForoBean.tituloPagina}" />
						...
						<tr:panelBox text="#{resCore['DATOS_FORO']}">
							...
							<trh:tableLayout
								...
								<trh:rowLayout>
									...
									<tr:inputText columns="53" value="#{editarForoBean.titulo}"
										id="titulo" maximumLength="50"/>
								</trh:rowLayout>
								<trh:rowLayout>
									<tr:outputText value="#{resCore['DESCRIPCION']} *"
										inlineStyle="font-weight: bolder;" />
									<tr:inputText columns="50" rows="3" value="#{editarForoBean.descripcion}"
										id="descripcion"  maximumLength="500" />
								</trh:rowLayout>
							</trh:tableLayout>
