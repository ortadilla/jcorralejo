...
<!-- DIV flotante para bloquear la pantalla en eventos PPR -->
        ...
        <h:form onsubmit="bloquearPantalla(this)">
          <tr:panelBox background="transparent" text="Ocurrencia de Transición">
            <tr:panelFormLayout>
              <f:facet name="footer"/>
              <tr:spacer width="10" height="10"/>
	          <tr:messages/>
              <tr:spacer width="10" height="10"/>
              <tr:panelLabelAndMessage label="La última vez que estuvo en">
              ...
              <tr:panelLabelAndMessage label="fué a">
