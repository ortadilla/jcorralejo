...
<!-- DIV flotante para bloquear la pantalla en eventos PPR -->
        ...
        <h:form onsubmit="bloquearPantalla(this)">
          ...
          <tr:spacer width="10" height="10"/>
           ...
           <tr:spacer width="10" height="10"/>
          <tr:table emptyText="No items were found" width="100%" selectionListener="#{tablaProcedimientoContratacionBean.eventoSeleccion}"
          	var="fila" autoSubmit="true" rowSelection="single"
          	value="#{tablaProcedimientoContratacionBean.modelo}"
          	selectedRowKeys="#{tablaProcedimientoContratacionBean.seleccionadas}">
            ...
            <tr:panelButtonBar>
              <tr:commandButton text="Agregar" action="#{agregarAccionTabla.ejecuta}" />
               <tr:commandButton text="Modificar"  action="#{modificarProcedimientoContratacion.ejecuta}" >
                </tr:commandButton>
                <tr:commandButton id="cbBaja" text="Baja" action="#{borrarProcedimientoContratacion.ejecuta}"/>
                   </tr:panelButtonBar>
            </f:facet>
          </tr:table>
          <tr:separator/>
