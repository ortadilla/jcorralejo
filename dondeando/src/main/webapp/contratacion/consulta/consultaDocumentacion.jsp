...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0"
  ...
  <f:view>
    <trh:html>
      <trh:head title="Documentación asociada al expediente">
...
<!-- DIV flotante para bloquear la pantalla en eventos PPR -->
        ...
        <tr:form usesUpload="true" onsubmit="bloquearPantalla(this)">
          <tr:panelHeader text="Documentación asociada al expediente"/>
          <tr:messages />
          ...
          <tr:panelBox background="medium"  >
            <tr:panelFormLayout>
              ...
              emptyText="No existe documentación asociada al expediente"
        	   rows="5" >

                <f:facet name="header">
                    <tr:outputText value="Documentación asociada al expediente" />
                </f:facet>
