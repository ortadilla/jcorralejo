...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0"
  ...
  <f:view>
    <trh:html>
      <trh:head title="#{solicitarMotivo.titulo}">
...
<!-- DIV flotante para bloquear la pantalla en eventos PPR -->
        ...
        <tr:form usesUpload="true" onsubmit="bloquearPantalla(this)">
          <tr:panelHeader text="#{solicitarMotivo.titulo}"/>
          <tr:messages />
              ...
              <f:facet name="footer">
	            <tr:panelGroupLayout inlineStyle="width:100%">
	              ...
	              <tr:panelFormLayout id="datosSolicitud" >
	                <tr:panelLabelAndMessage label="#{solicitarMotivo.etiqueta}" labelStyle="width:350px">
	                <tr:inputText value="#{solicitarMotivo.texto}" simple="true"
								maximumLength="250" columns="100" rows="3" />
	                </tr:panelLabelAndMessage>
	              </tr:panelFormLayout>
	              <tr:separator/>
                  <tr:panelHorizontalLayout halign="right">
                    <tr:commandButton text="Aceptar" actionListener="#{solicitarMotivo.aceptar}" />
