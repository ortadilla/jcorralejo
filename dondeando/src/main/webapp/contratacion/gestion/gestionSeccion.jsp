							...
							<h:panelGroup>
								<tr:panelHorizontalLayout halign="right">
									<tr:commandButton text="Aceptar"
										action="#{gestionSeccion.actualizarYSalir}" />
									<tr:commandButton text="Cancelar"
										action="#{gestionSeccion.cancelar}" />
								</tr:panelHorizontalLayout>
							</h:panelGroup>
						</f:facet>
						<tr:panelLabelAndMessage label="Código">
							<tr:inputText value="#{gestionSeccion.codigoSeccion}"
								simple="true" />
						</tr:panelLabelAndMessage>

						<tr:panelLabelAndMessage label="Descripción">
							<tr:inputText value="#{gestionSeccion.descripcion}" simple="true" />
						</tr:panelLabelAndMessage>
						<tr:panelLabelAndMessage label="Orden">
							<tr:inputText value="#{gestionSeccion.orden}" simple="true" />
						</tr:panelLabelAndMessage>
