		...
		<trh:body initialFocusId="nombre">
			...
			<tr:form defaultCommand="btnAceptar" id="formCrearUsuario"
				...
				<tr:panelPage>
					...
					<tr:panelHeader text="#{editarOpinionLocalBean.tituloPagina}" />
					<tr:panelHorizontalLayout halign="center">
						<tr:spacer width="10" />
						<tr:panelBox text="#{resCore['OPINION']}" inlineStyle="width:100%;">
							<tr:spacer height="20" />
							<trh:tableLayout
								inlineStyle="border-style: solid; border-width: 1px;"
								cellSpacing="5" cellPadding="0">
								<trh:rowLayout>
									<tr:outputText value="#{resCore['OPINION']} *"
										inlineStyle="font-weight: bolder;" />
									<tr:inputText columns="50" rows="5"
										value="#{editarOpinionLocalBean.opinion}" id="descripcion"
										maximumLength="2000" />
								</trh:rowLayout>
							</trh:tableLayout>
							...
							<tr:panelHorizontalLayout halign="center">
								<tr:commandButton text="#{resCore['ACEPTAR']}" id="btnAceptar"
									action="#{editarOpinionLocalBean.aceptar}" />
								<tr:spacer width="20" height="10" />
								<tr:commandButton text="#{resCore['CANCELAR']}" id="btnCancelar"
									immediate="true" action="#{editarOpinionLocalBean.cancelar}" />
